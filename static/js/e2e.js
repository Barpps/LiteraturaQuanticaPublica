...
async function runE2E(){
  ...
  var modules = [\r\n    { n:'Prosperidade Consciente + Serenidade', u:'static/config/modules/frequencias_diarias.json' },\r\n    { n:'O Sil�ncio entre os Raios', u:'static/config/modules/silencio_entre_os_raios.json' },\r\n    { n:'Presen�a Divina na A��o', u:'static/config/modules/presenca_divina_acao.json' },\r\n    { n:'PAZ � P�r do Sol da Integra��o', u:'static/config/modules/paz_por_do_sol.json' },\r\n    { n:'PLENITUDE � Coluna de Luz do Todo', u:'static/config/modules/plenitude_coluna_de_luz.json' }\r\n  ];
